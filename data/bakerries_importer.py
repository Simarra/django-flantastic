...
COLS_TO_KEEP = ['siren', 'codpos', 'libcom',  'enseigne',  'apet700', 'libapet',  'nomen_long', 'sigle', 'nom', 'prenom', 'civilite',  'vmaj',
                'vmaj1', 'vmaj2', 'vmaj3', 'datemaj', 'latitude', 'longitude', 'geo_score', 'geo_type', 'geo_adresse', 'geo_id', 'geo_ligne', 'geo_l4', 'geo_l5']
